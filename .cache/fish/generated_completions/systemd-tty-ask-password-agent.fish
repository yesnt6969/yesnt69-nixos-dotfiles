...
complete -c systemd-tty-ask-password-agent -l list -d 'Lists all currently pending system password requests. sp Added in version 186'
...
complete -c systemd-tty-ask-password-agent -l watch -d 'Continuously process password requests. sp Added in version 186'
