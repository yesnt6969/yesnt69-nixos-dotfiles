# chpasswd
# Autogenerated from man page /run/current-system/sw/share/man/man8/chpasswd.8.gz
...
complete -c chpasswd -s P -l prefixPREFIX_DIR -d 'Apply changes to configuration files under the root filesystem found under th…'
