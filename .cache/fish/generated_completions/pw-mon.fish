# pw-mon
# Autogenerated from man page /run/current-system/sw/share/man/man1/pw-mon.1.gz
...
complete -c pw-mon -s N -l color -d 'Whether to use color, one of \'never\', \'always\', or \'auto\''
