# rmmod
# Autogenerated from man page /run/current-system/sw/share/man/man8/rmmod.8.gz
...
complete -c rmmod -s r -d 'option instead since it removes unused dependent modules as well.  OPTIONS'
