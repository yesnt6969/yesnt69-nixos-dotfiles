...
complete -c coredumpctl -s o -l output -d 'Write the core to FILE. sp Added in version 215'
...
complete -c coredumpctl -s D -l directory -d 'Use the journal files in the specified DIR. sp Added in version 225'
complete -c coredumpctl -l root -d 'Use root directory ROOT when searching for coredumps. sp Added in version 252'
