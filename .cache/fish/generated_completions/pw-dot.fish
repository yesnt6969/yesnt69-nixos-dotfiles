# pw-dot
# Autogenerated from man page /run/current-system/sw/share/man/man1/pw-dot.1.gz
...
complete -c pw-dot -s L -l lr -d 'Lay the graph from left to right, instead of dot\'s default top to bottom'
