# vipw
# Autogenerated from man page /run/current-system/sw/share/man/man8/vipw.8.gz
...
complete -c vipw -s u -l user -d 'Indicates which user\\*(Aqs tcb shadow file to edit'
